...
"""
ActorCriticMode13A4: Actor和Critic都用2DCNN处理单帧高程图

网络结构:
    Critic Pipeline:
    - 单帧本体特权观测 + 单帧高程图(2DCNN提取特征) -> concat -> Critic网络 -> Value
    ...
    相比Mode13A3的改进：
    - Critic也使用2DCNN提取高程图特征，而不是简单展平
    - Actor和Critic可以共享或独立配置2DCNN编码器
"""
...
class ActorCriticMode13A4(nn.Module):
    ...
    def __init__(
        ...
        **kwargs: dict[str, Any],
        ...
        # Actor 2DCNN编码器：单帧高程图 -> 2DCNN -> 视觉特征
        ...
        print(f"Actor 2DCNN Encoder: {self.elevation_2dcnn_encoder_actor}")
        
        # Critic 2DCNN编码器：单帧高程图 -> 2DCNN -> 视觉特征
        ...
        print(f"Critic 2DCNN Encoder: {self.elevation_2dcnn_encoder_critic}")
    ...
    def act(self, obs: TensorDict, **kwargs: dict[str, Any]) -> torch.Tensor:
        ...
        处理流程：
        1. 提取单帧高程图 -> 归一化 -> Actor 2DCNN -> 视觉特征
    ...
    def evaluate(self, obs: TensorDict, **kwargs: dict[str, Any]) -> torch.Tensor:
        ...
        处理流程：
        1. 提取单帧高程图 -> 归一化 -> Critic 2DCNN -> 视觉特征
        2. 提取本体特权观测 -> 归一化
...
class _OnnxPolicyExporter(torch.nn.Module):
    ...
    def __init__(self, policy: ActorCriticMode13A4, normalizer=None, verbose=False):
        super().__init__()
