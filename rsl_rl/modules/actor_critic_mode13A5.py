...
class _OnnxPolicyExporter(torch.nn.Module):
    ...
    def forward(self, proprio_obs, elevation_obs):
        ...
        Args:
            ...
            elevation_obs: 高程图历史，形状为 [batch_size, history_length, height, width]
        Returns:
    ...
    def export(self, path, filename):
        ...
        elevation_obs = torch.zeros(1, history_length, height, width)
        ...
        print(f"  输入2: 高程图历史,  shape: [batch, {history_length}, {height}, {width}]")
        print(f"{'='*80}\n")
